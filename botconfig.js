module.exports = {
  ...
  Token: process.env.Token || "ODk0MjExMjkwMTgzMTEwNzA2.YVmtKQ.McCbDhU9YETJt9ahO_cDgHlR6ag", //Discord Bot Token
  ClientID: process.env.Discord_ClientID || "894211290183110706", //Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "f9AsAsoBYI0WZKAa85I0JGxzAL84JGYO", //Discord Client Secret
  ...
  Website: process.env.Website || "https://Sayu-bot-music-discord.neonddroid.repl.co", //Website where it is hosted at includes http or https || Use "0.0.0.0" if you using Heroku || Do not include /api/callback. Just the website url. I.e. "https://foo.bar"
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "70e3e3c6e24e47af81970e42b2215e18", //Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "bfa9a2cc9094492f9e95b193fe2fd0f6", //Spotify Client Secret
  },
};
